...
const TodoList: React.FC = () => {
  ...
  return (
    <div className="grid justify-center p-4">
      <h1 className="text-2xl font-bold mb-4 text-center">A Demo Todo List</h1>
      <h2 className="text-xl font-semibold mb-4 italic">Connecting the Front End with the Back End</h2>
        ...
        {todos.map(todo => (
          <li key={todo._id} className="mb-2 grid grid-cols-4">
            ...
            <button
              ...
              className="px-2 py-1 rounded ms-auto col-span-1"
            >
              <CloseIcon />
            </button>
          </li>
